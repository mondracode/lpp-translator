...
public interface lppListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link lppParser#exp_lea}.
	 * @param ctx the parse tree
	 */
	void enterExp_lea(lppParser.Exp_leaContext ctx);
	/**
	 * Exit a parse tree produced by {@link lppParser#exp_lea}.
	 * @param ctx the parse tree
	 */
	void exitExp_lea(lppParser.Exp_leaContext ctx);
	/**
