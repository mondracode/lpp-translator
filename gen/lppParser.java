...
public class lppParser extends Parser {
	...
	public static final int
		...
		RULE_si_aux = 23, RULE_sino = 24, RULE_caso = 25, RULE_opcion = 26, RULE_opcion_exp = 27, 
		RULE_caso_sino = 28, RULE_repita = 29, RULE_para = 30, RULE_mientras = 31, 
		RULE_asigne = 32, RULE_retorne = 33, RULE_exp = 34, RULE_op_o = 35, RULE_op_y = 36, 
		RULE_op_div = 37, RULE_op_mod = 38, RULE_operator = 39, RULE_literal = 40, 
		RULE_tipo = 41, RULE_tipo_variable = 42, RULE_cadena = 43, RULE_arreglo = 44, 
		RULE_arreglo_variable = 45, RULE_exp_list = 46;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"si", "si_aux", "sino", "caso", "opcion", "opcion_exp", "caso_sino", 
	...
	public static class Dec_variables_intContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof lppVisitor ) return ((lppVisitor<? extends T>)visitor).visitDec_variables_int(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Dec_variable_intContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof lppVisitor ) return ((lppVisitor<? extends T>)visitor).visitDec_variable_int(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Parametro_sigContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof lppVisitor ) return ((lppVisitor<? extends T>)visitor).visitParametro_sig(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Parametros_procContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof lppVisitor ) return ((lppVisitor<? extends T>)visitor).visitParametros_proc(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Parametro_sig_procContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof lppVisitor ) return ((lppVisitor<? extends T>)visitor).visitParametro_sig_proc(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Prog_procContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof lppVisitor ) return ((lppVisitor<? extends T>)visitor).visitProg_proc(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Prog_mainContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof lppVisitor ) return ((lppVisitor<? extends T>)visitor).visitProg_main(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Si_auxContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof lppVisitor ) return ((lppVisitor<? extends T>)visitor).visitSi_aux(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Si_auxContext si_aux() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_si_aux);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(248);
	...
	public final OpcionContext opcion() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_opcion);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(270);
	...
	public static class Opcion_expContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof lppVisitor ) return ((lppVisitor<? extends T>)visitor).visitOpcion_exp(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Opcion_expContext opcion_exp() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_opcion_exp);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(274);
	...
	public final Caso_sinoContext caso_sino() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_caso_sino);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(276);
	...
	public final RepitaContext repita() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_repita);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(280);
	...
	public final AsigneContext asigne() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_asigne);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(303);
	...
	public static class Op_oContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof lppVisitor ) return ((lppVisitor<? extends T>)visitor).visitOp_o(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Op_oContext op_o() throws RecognitionException {
		...
		enterRule(_localctx, 70, RULE_op_o);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(362);
	...
	public static class Op_yContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof lppVisitor ) return ((lppVisitor<? extends T>)visitor).visitOp_y(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Op_yContext op_y() throws RecognitionException {
		...
		enterRule(_localctx, 72, RULE_op_y);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(364);
	...
	public static class Op_divContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof lppVisitor ) return ((lppVisitor<? extends T>)visitor).visitOp_div(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Op_divContext op_div() throws RecognitionException {
		...
		enterRule(_localctx, 74, RULE_op_div);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(366);
	...
	public static class Op_modContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof lppVisitor ) return ((lppVisitor<? extends T>)visitor).visitOp_mod(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Op_modContext op_mod() throws RecognitionException {
		...
		enterRule(_localctx, 76, RULE_op_mod);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(368);
	...
	public static class OperatorContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof lppVisitor ) return ((lppVisitor<? extends T>)visitor).visitOperator(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Tipo_variableContext tipo_variable() throws RecognitionException {
		...
		enterRule(_localctx, 84, RULE_tipo_variable);
		try {
			setState(397);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final CadenaContext cadena() throws RecognitionException {
		...
		enterRule(_localctx, 86, RULE_cadena);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(399);
	...
	public final ArregloContext arreglo() throws RecognitionException {
		...
		enterRule(_localctx, 88, RULE_arreglo);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(404);
	...
	public final Arreglo_variableContext arreglo_variable() throws RecognitionException {
		...
		enterRule(_localctx, 90, RULE_arreglo_variable);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(411);
	...
	public final Exp_listContext exp_list() throws RecognitionException {
		...
		enterRule(_localctx, 92, RULE_exp_list);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
