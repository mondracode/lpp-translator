...
public interface lppVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link lppParser#dec_variables_int}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDec_variables_int(lppParser.Dec_variables_intContext ctx);
	/**
	 * Visit a parse tree produced by {@link lppParser#dec_variable_int}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDec_variable_int(lppParser.Dec_variable_intContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link lppParser#parametros_proc}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitParametros_proc(lppParser.Parametros_procContext ctx);
	/**
	 * Visit a parse tree produced by {@link lppParser#parametro_sig_proc}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitParametro_sig_proc(lppParser.Parametro_sig_procContext ctx);
	/**
	 * Visit a parse tree produced by {@link lppParser#prog_proc}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitProg_proc(lppParser.Prog_procContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link lppParser#exp_lea}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExp_lea(lppParser.Exp_leaContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link lppParser#si_aux}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSi_aux(lppParser.Si_auxContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link lppParser#opcion_exp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOpcion_exp(lppParser.Opcion_expContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link lppParser#op_o}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOp_o(lppParser.Op_oContext ctx);
	/**
	 * Visit a parse tree produced by {@link lppParser#op_y}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOp_y(lppParser.Op_yContext ctx);
	/**
	 * Visit a parse tree produced by {@link lppParser#op_div}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOp_div(lppParser.Op_divContext ctx);
	/**
	 * Visit a parse tree produced by {@link lppParser#op_mod}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOp_mod(lppParser.Op_modContext ctx);
	/**
